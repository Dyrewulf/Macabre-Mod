...
public class BlockSanguineFluidBlock extends BlockFluidClassic
{
	...
	public BlockSanguineFluidBlock(Fluid fluid, Material material)
	{
		super(fluid, material);
		setBlockName("sanguineFluidBlock");
