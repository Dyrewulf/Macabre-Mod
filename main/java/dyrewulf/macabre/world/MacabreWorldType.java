...
public class MacabreWorldType extends WorldType
{
private boolean hasNotificationData;

public static WorldType macabreDimOverWorld;

public MacabreWorldType(String name) {
	super(name);
}

public static void addCustomWorldTypes(){
	macabreDimOverWorld = new MacabreWorldType("Macabre").setNotificationData();
}

@Override
public WorldChunkManager getChunkManager(World world) {
	return new WorldChunkManagerHell(BiomeGenBase.desert, 0.5F);
}
