package dyrewulf.macabre.world.gen;
...
public class WorldGenMacabreTrees extends WorldGenForestAbstractTree
{
    ...
    public WorldGenMacabreTrees(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 6, leaves, wood, false);
    }

    public WorldGenMacabreTrees(boolean p_i2028_1_, int minTreeHeight, Block metaWood, Block metaLeaves, boolean growVines)
    {
        super(p_i2028_1_);
        this.minTreeHeight = minTreeHeight;
        WorldGenMacabreTrees.wood = metaWood;
        WorldGenMacabreTrees.leaves = metaLeaves;
