...
public class WorldGenMacabreMinable extends WorldGenerator
{
	/** Block to replace */
	 ...
	 */
	public WorldGenMacabreMinable(Block blockToPlace, int howMeny, Block replaceableBlock)
	{
	 ...
	 * @param target
	 */
	public WorldGenMacabreMinable(Block block, int meta, int number, Block target)
	{
