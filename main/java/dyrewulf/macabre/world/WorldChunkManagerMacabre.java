...
import dyrewulf.macabre.biomes.genlayer.BoneDesertGenLayer;

public class WorldChunkManagerMacabre extends WorldChunkManager {
	...
	public WorldChunkManagerMacabre()
	{
	...
	public WorldChunkManagerMacabre(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = BoneDesertGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerMacabre(World world)
	{
