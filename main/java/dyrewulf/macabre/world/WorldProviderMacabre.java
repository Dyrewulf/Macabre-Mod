package dyrewulf.macabre.world;
...
import dyrewulf.macabre.renderer.CloudRenderer;
import dyrewulf.macabre.renderer.SkyRenderer;
import dyrewulf.macabre.renderer.WeatherRenderer;

public class WorldProviderMacabre extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderMacabre(this.worldObj, this.worldObj.getSeed(), true);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerMacabre(worldObj.getSeed(), terrainType);
		this.dimensionId = Reference.MACABREDIMID;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(Reference.MACABREDIMID);
	}
	...
	public String getSaveFolder() {
			return "DIM" + Reference.MACABREDIMID;
	}
	...
	{
		return "Entering a plane of existance between life and death";
	}
