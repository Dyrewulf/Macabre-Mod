...
import dyrewulf.macabre.biomes.decorator.BiomeDecoratorMod;
import dyrewulf.macabre.help.Reference;

public class MacabreBiomes extends BiomeGenBase {

    /** The biome height */
    public static final BiomeGenBase.Height biomeHeight = new BiomeGenBase.Height(0.3F, 0.6F);

    public static BiomeGenBase boneDesert;
    public static BiomeGenBase plainDesert;

    public MacabreBiomes(int biomeId) {
        super(biomeId);
        this.theBiomeDecorator = new BiomeDecoratorMod();
    }

    static {
        boneDesert = (new BiomeBoneDesert(Reference.BONEDESERTID).setColor(16421912).setTemperatureRainfall(2.0F, 0.0F).setHeight(height_LowPlains).setBiomeName("Bone Desert"));
        plainDesert = (new BiomePlainDesert(Reference.DESID).setColor(16421912).setTemperatureRainfall(2.0F, 0.0F).setHeight(height_LowPlains).setBiomeName("Plain ole Desert"));
    }
    ...
    {
		BiomeDictionary.registerBiomeType(boneDesert, Type.DRY, Type.SANDY, Type.DEAD, Type.WASTELAND);
		BiomeDictionary.registerBiomeType(plainDesert, Type.DRY, Type.SANDY);
