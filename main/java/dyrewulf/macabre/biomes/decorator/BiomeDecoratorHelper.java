...
import dyrewulf.macabre.biomes.BiomeBoneDesert;
...
public class BiomeDecoratorHelper {
    ...
    private static WorldGenerator bonePile;
...
/*
        if(biome == MacabreBiomes.boneDesert)
        {
            BiomeDecoratorMod.howMenyTrees = BiomeBoneDesert.treesPerChunk;
...
*/    }
    ...
    private static void initOres() {
        bonePile = new WorldGenMinable(Blocks.glowstone, 30, Macabre.bonePile);
    }
    ...
    private static void generateOreInBiome(BiomeGenBase biome){
        if(biome == MacabreBiomes.boneDesert){
            genStandardOre(20, bonePile, 0, 128);
        }
    }
